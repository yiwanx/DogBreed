...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    lazy var breedListNC: UINavigationController = {
        ...
        nc.tabBarItem = .init(title: "List", image: UIImage(systemName: "list.star")?.withTintColor(.lightText), selectedImage: UIImage(systemName: "list.star"))
        return nc
    }()
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        tabVC.setViewControllers(controllers, animated: false)
